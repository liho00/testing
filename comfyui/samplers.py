...
class KSAMPLER(Sampler):
    ...
    def sample(self, model_wrap, sigmas, extra_args, callback, noise, latent_image=None, denoise_mask=None, disable_pbar=False):
        ...
        print("latent_image liho", latent_image.shape)
        ...
        print("noise", noise.shape, noise.type(), noise.device)
        k_callback = None
...
class CFGGuider:
    ...
    def sample(self, noise, latent_image, sampler, sigmas, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
        ...
        print("debuglog device", device)
        print("debuglog noise", noise.shape, noise.type())
        print("debuglog latent_image", latent_image.shape, latent_image.type())
